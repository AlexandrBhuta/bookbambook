...
<div class="left_block">
	...
	<div class="sidearea">
		...
		<?$APPLICATION->IncludeComponent(
			...
			"tizers2",
			array(
				"IBLOCK_TYPE" => "aspro_landscape_content",
				"IBLOCK_ID" => CCache::$arIBlocks[SITE_ID]["aspro_landscape_content"]["aspro_landscape_front_tizers"][0],
				"NEWS_COUNT" => "100",
				"SORT_BY1" => "SORT",
				"SORT_ORDER1" => "ASC",
				"SORT_BY2" => "ID",
	...
	"catalog_table", 
	array(
		"IBLOCK_TYPE" => "aspro_landscape_catalog",
		"IBLOCK_ID" => "252",
		"NEWS_COUNT" => "1",
		"COUNT_IN_LINE" => "1",
		"SORT_BY1" => "RAND",
